Weather Dashboard: a dashboard that allows you to search cities and check out weather forecasts, humidity, wind speed etc with an OpenWeather API fetch using Javascript, HTML and CSS. 
